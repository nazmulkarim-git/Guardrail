import { apiError, generateApiKey, getSql, hashApiKey, json, newId, normalizeString, publicApiError, readBody, requireAdmin } from "../_forsig-core.js";
...
export default async function handler(req, res) {
  ...
  try {
    ...
    await db`
      ...
      values (${id}, ${workspaceId}, ${name}, ${hashApiKey(key)}, ${prefix}, now())
    `;
    ...
    console.error("Admin API key failed", { code: error.code, message: error.message, detail: error.detail });
